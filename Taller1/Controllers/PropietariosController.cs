...
namespace Taller1.Controllers
{
    public class PropietariosController : Controller
    {
        ...
        public PropietariosController(Taller1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Apellido,fecha,Ecuatoriano")] Propietario propietario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Apellido,fecha,Ecuatoriano")] Propietario propietario)
        {
